...
H_AGENT_REPLAY_BUFFER_SIZE = int(1e5)
TRAJECTORY_BUFFER_SIZE = int(1e6)
BATCH_SIZE = 512
...
STORE_TRANSITION_CYCLE = 60 * 5  # dump transitions to DQN every 5 min
TRAINING_CYCLE = 1 * 60  # min
UPDATE_CYCLE = 1000 * 60  # update per 1000 tick
SAVING_CYCLE = 60 * 24 * 1 # save per day
DQN_RESUME = False
CNN_RESUME = False
HRL_RESUME = False
